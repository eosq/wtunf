...
<html lang="en">
   <head>
      ...
      <script src="style/js/rwd-table.js"></script>
      <script src="style/js/sort.js"></script>
	  <link rel="stylesheet" href="style/css/rwd-table.min.css">
      <link href="/twitter/images/icon.png" rel="icon" type="image/x-icon">
      <script>
         function VievDB () {
           var str = $("#twi").serialize();
           $.post("vievdb.php", str, function(data) {
             $("#twit").html(data);
           });
         }
         function UpdateDb () {
         ...
         function CreateDb () {
         var str = $("#createdb").serialize();
         $.post("crtable.php", str, function(data) {
           $("#crtable").html(data);
         });
         }
      </script>
      ...
      <div class="container">
         ...
         <div  class="col-md-12">
            <ul class="nav nav-pills">
              <li><input id="createdb" class="btn btn-default btn-lg" onclick="CreateDb(); return false;" type="button" value="Create table"></li>
               <li><input id="db" class="btn btn-default btn-lg" onclick="UpdateDb(); return false;" type="button" value="Update table"></li>
               <li><input id="tweetinf" class="btn btn-default btn-lg" onclick="UpdateTweets(); return false;" type="button" value="Update tweets info"> </li>
            </ul>
            <br />
            <div class="col-md-4" id="crtable"></div>
         </div>
         ...
         <div  class="well col-md-12">
           <form class="form-inline" id="twi" role="form">
                ...
                <div class="form-group col-md-12">
                   <input class="btn btn-primary btn-lg" onclick="VievDB(); return false;" type="button" value="Look">
                </div>
             </form>
         </div>
         <br />
