...
class TwitterOAuth extends Config
{
    ...
    public function follow($username)
    	{
    		return $this->post('friendships/create', array('screen_name' => $username));
    	}
      public function loadUserInfo($username)
      	{
      		return $this->get('users/show', array('screen_name' => $username));
      	}
...
public function statusesMentionsTimeline(
   ...
   $trimUser = null, $contributorDetails = null, $includeEntities = null
     )
     {
           ...
           public function send($message, $in_reply_to_status_id=NULL, $media = NULL)
       	{
          if ($in_reply_to_status_id != null) {
            $parameters['in_reply_to_status_id'] = (int) $in_reply_to_status_id;
        }

        if ($media != null) {
          $media1 = $this->upload('media/upload', ['media' => $media]);
          $parameters['media_ids'] = implode(',', [$media1->media_id_string]);
        }
$parameters['status']=$message;
  ...
  return $this->post('statuses/update', $parameters);
        ...
        public function loadUserFollowers($username, $cursor = -1)
        	{

        		return $this->get('followers/ids', array(
     ...
     $parameters['user_id'] = implode(',', $userIds);
      ...
      return $this->get('users/lookup', $parameters);
             ...
             public function get_user_timeline(
                  $screen_name=null,$count = null, $sinceId = null, $maxId = null,
                 $contributorDetails = null, $includeEntities = null
                  )
                  {
                            // build parameters
                            $parameters = null;
                        ...
                        public function StatusesLookup(
                        $userIds = null, $screenNames = null, $includeEntities = null
                                     )
                                     {
                                         // redefine
